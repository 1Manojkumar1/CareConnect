...
export function NotFound() {
  return (
    <div className="mx-auto max-w-md text-center">
      ...
      <Link to="/" className="inline-flex h-10 items-center rounded bg-brand-700 px-4 text-sm font-medium text-white no-underline hover:bg-brand-800 hover:no-underline">
        Back to home
      </Link>
    </div>
  );
